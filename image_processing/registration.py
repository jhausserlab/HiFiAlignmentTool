...
def get_metadata(filename, img_shape, mrk_nm, resolution):
  ...
  #mdata = mdata + '''<Pixels ID="Pixels:0" DimensionOrder="XYCZT" PhysicalSizeX="'''+str(resolution)+'''" PhysicalSizeY="'''+str(resolution)+'''" Type="uint16" SizeC="'''+str(img_shape[0])+'''" SizeT="1" SizeX="'''+str(img_shape[2])+'''" SizeY="'''+str(img_shape[1])+'''" SizeZ="1">'''
